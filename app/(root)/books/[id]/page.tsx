    ...
    <div className="p-2 lg:p-10 lg:mt-2 lg:ml-20">
      <div className="font-sans">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-start mb-10">
          ...
          <div className="ml-10 md:flex flex-row flex-wrap lg:grid grid-cols-2 lg:gap-10 justify-start mt-0 lg:mt-0 lg:ml-15">
            {thumbnails.map((thumbnail, index) => (
              <div key={index} className="p-2 flex items-center justify-center transition-transform duration-300 ease-in-out transform hover:scale-110 border border-gray-300 rounded shadow-lg w-[70px] h-[80px] sm:w-[100px] sm:h-[100px] md:w-[100px] md:h-[100px] lg:w-[280px] lg:h-[280px] lg:p-7 lg:px-9">
                <Image
                  src={thumbnail}
