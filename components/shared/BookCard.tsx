...
const BookCard = ({ userId, bookId, title, imageUrl, author, price, salePrice, favorites, bookOwnerId, isProfilePage }: BookCardProps) => {
      ...
      <div className="flex flex-col items-start justify-center w-full h-full px-[7px] lg:px-[18px] xl:px-[25px] pt-[10px] md:pt-[13px]">
        ...
        {isProfilePage && userId === bookOwnerId && (
          <div className="flex justify-center mt-3 gap-2 mb-3">
            <button className="px-3 py-1 shadow-xl bg-gradient-to-r from-yellow-600 to-orange-600 text-white text-sm rounded-lg hover:bg-gradient-to-r hover:from-red-900 hover:to-red-800">
              Mark as Sold
            </button>
