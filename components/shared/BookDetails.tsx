...
const BookDetails = ({ book, userId, bookOwner, favorites }: BookDetailsProps) => {
    ...
    >
      <div className="font-sans">
        <motion.button
          ...
          className="flex items-center text-indigo-900 left-5 hover:big mb-4"
          whileHover={{ scale: 1.1 }}
        >
          <Image src="/assets/icons/back.svg" alt="Go Back" width={15} height={20} className="mr-2" />
          Back to Search
        </motion.button>
