...
import { ChangeEvent, ReactEventHandler, useEffect, useState, useMemo } from 'react';
...
const Filters = () => {
    ...
    const visibleCategories = useMemo(() => categories.slice(0, showMoreCategories), [categories, showMoreCategories]);
